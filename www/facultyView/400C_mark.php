...
$page = "SELECT * FROM `400c_mark` ORDER BY student_id DESC";
...
$sql = "SELECT * FROM `400c_mark` ORDER BY `student_id` DESC LIMIT $start_from,$num_per_page";
...
if (isset($_POST['search_submit'])) {
    ...
    $search = $_POST['search'];
    $sql = "SELECT * FROM `400c_mark` WHERE `student_id` LIKE '%$search%' ORDER BY student_id DESC LIMIT $start_from,$num_per_page";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="my-5">
                ...
                <form class="d-flex" role="search" action="400c_mark.php" method="POST">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "
                                        <tr>
                                            ...
                                            <td>
                                                <a class='btn btn-outline-primary' href='400c_mark_edit.php?student_id=$row[student_id]'>Edit</a> &nbsp;
                                                <a class='btn btn-outline-danger' href='400c_mark_del.php?student_id=$row[student_id]'>Delete</a>
                                            </td>
