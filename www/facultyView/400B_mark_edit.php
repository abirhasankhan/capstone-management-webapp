...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM 400b_mark WHERE student_id = '$student_id'";
    ...
    do {
        ...
        $sql = "UPDATE `400b_mark` SET `mark`='$mark ',`semester`='$semYear' WHERE `student_id`='$student_id'";
...
<body style="background-color: #f2f6ff;">
    ...
    <div style="margin-left: 10%; margin-top: 50px;">
        <h2> <b>400B mark update</b></h2>
    </div>

    <div>
        <div class="container my-5">
            <h2>update student mark 400B</h2>
            <br>
            ...
            <div>
                ...
                if (!empty($errorMessage)) {
                    ...
                    echo '    window.location.href = "400B_mark.php";';
            ...
            <form method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="400B_mark.php" role="button">Cancel</a>
                    </div>
