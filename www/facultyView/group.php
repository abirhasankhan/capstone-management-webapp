...
$sql = "SELECT `group_req`.`group_id`, `group_req`.`std_1`, `group_req`.`std_2`, `group_req`.`std_3`, `group_req`.`std_4`, `group_req`.`dept_name` FROM `group` JOIN `group_req` WHERE `group_req`.`group_id` = `group`.`group_id` AND `group`.`faculty_id` = '$userID' AND `group_req`.`status` = 'on_going'";
...
<body style="background-color: #f2f6ff;">
    ...
    <div style="margin-right: 10%; margin-top: 50px; text-align: right;">
        <h4> <b><a class="nav-link" style="color:coral" href="overPastGroup.php">Overpast Group List</a></b></h4>
    </div>
            ...
            <div style="padding-top: 25px;">
                ...
                <div class="row gy-3 my-3">
                    ...
                    <?php
                        ...
                        // for group details
                        function getThesisInfo($group_id, $conn)
                        {
                            $sql = "SELECT * FROM grp_thesis_type WHERE group_id = '$group_id'";
                            $result = $conn->query($sql);
                                    ...
                                    <table class='table table-light table table-hover table table-bordered border border-dark' style='width:100%'>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>" . getThesisInfo($row['group_id'], $conn) . "</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ";
                            ...
                            echo "
                                <div>
                                    <h1>Your group hasn't been assigned yet</h1>
                                </div>
